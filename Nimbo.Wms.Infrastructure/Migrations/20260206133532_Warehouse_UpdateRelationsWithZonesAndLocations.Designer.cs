...
namespace Nimbo.Wms.Migrations
{
    ...
    [Migration("20260206133532_Warehouse_UpdateRelationsWithZonesAndLocations")]
    partial class Warehouse_UpdateRelationsWithZonesAndLocations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nimbo.Wms.Domain.Documents.Outbound.ShipmentOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("shipment_orders", "nimbo");
                });

            modelBuilder.Entity("Nimbo.Wms.Domain.Documents.Outbound.ShipmentOrderLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Nimbo.Wms.Domain.Documents.Transfer.TransferOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("transfer_orders", "nimbo");
                });

            modelBuilder.Entity("Nimbo.Wms.Domain.Documents.Transfer.TransferOrderLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Nimbo.Wms.Domain.Documents.Transfer.TransferOrderLine", b =>
                {
                    ...
                    b.OwnsOne("Nimbo.Wms.Domain.ValueObject.Quantity", "PickedQuantity", b1 =>
                        {
                            b1.Property<Guid>("TransferOrderLineId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("TransferOrderLineId");

                            b1.ToTable("transfer_order_lines", "nimbo");

                            b1.WithOwner()
                                .HasForeignKey("TransferOrderLineId");
                        });

                    b.OwnsOne("Nimbo.Wms.Domain.ValueObject.Quantity", "PlannedQuantity", b1 =>
                        {
                            b1.Property<Guid>("TransferOrderLineId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("Nimbo.Wms.Domain.ValueObject.Quantity", "ReceivedQuantity", b1 =>
                        {
                            b1.Property<Guid>("TransferOrderLineId")
                                .HasColumnType("uuid");
