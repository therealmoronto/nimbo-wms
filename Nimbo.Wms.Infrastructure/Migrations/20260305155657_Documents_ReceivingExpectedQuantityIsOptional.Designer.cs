...
namespace Nimbo.Wms.Migrations
{
    ...
    [Migration("20260305155657_Documents_ReceivingExpectedQuantityIsOptional")]
    partial class Documents_ReceivingExpectedQuantityIsOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nimbo.Wms.Domain.Entities.Documents.CycleCount.CycleCountDocumentLine", b =>
                {
                    ...
                    b.OwnsOne("Nimbo.Wms.Domain.ValueObject.Quantity", "ActualQuantity", b1 =>
                        {
                            b1.Property<Guid>("CycleCountDocumentLineId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("CycleCountDocumentLineId");

                            b1.ToTable("cycle_count_document_lines", "nimbo");

                            b1.WithOwner()
                                .HasForeignKey("CycleCountDocumentLineId");
                        });
            ...
            modelBuilder.Entity("Nimbo.Wms.Domain.Entities.Ledger.StockLedgerEntry", b =>
                {
                    b.OwnsOne("Nimbo.Wms.Domain.ValueObject.Quantity", "BalanceAfter", b1 =>
                        {
                            b1.Property<Guid>("StockLedgerEntryId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("StockLedgerEntryId");

                            b1.ToTable("stock_ledger_entries", "nimbo");

                            b1.WithOwner()
                                .HasForeignKey("StockLedgerEntryId");
                        });

                    b.OwnsOne("Nimbo.Wms.Domain.ValueObject.QuantityDelta", "QuantityDelta", b1 =>
                        {
                            b1.Property<Guid>("StockLedgerEntryId")
                                .HasColumnType("uuid");
