...
[PublicAPI]
internal sealed class AddSupplierItemCommandHandler : IRequestHandler<AddSupplierItemCommand, Result<Guid>>
{
    ...
    public async Task<Result<Guid>> Handle(AddSupplierItemCommand command, CancellationToken ct = default)
    {
