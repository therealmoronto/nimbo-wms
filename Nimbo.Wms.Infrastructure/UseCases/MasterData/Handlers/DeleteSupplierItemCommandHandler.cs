...
[PublicAPI]
internal sealed class DeleteSupplierItemCommandHandler : IRequestHandler<DeleteSupplierItemCommand>
{
    ...
    public async Task Handle(DeleteSupplierItemCommand command, CancellationToken ct = default)
    {
