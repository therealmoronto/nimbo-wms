...
[PublicAPI]
internal sealed class PatchSupplierCommandHandler : IRequestHandler<PatchSupplierCommand, Result>
{
    ...
    public async Task<Result> Handle(PatchSupplierCommand command, CancellationToken ct = default)
    {
