...
[PublicAPI]
internal sealed class AddLocationRequestHandler : IRequestHandler<AddLocationRequest, LocationId>
{
    private readonly IWarehouseRepository _repository;
    private readonly IUnitOfWork _unitOfWork;

    public AddLocationRequestHandler(IWarehouseRepository repository, IUnitOfWork unitOfWork)
    {
        _repository = repository;
        _unitOfWork = unitOfWork;
    }

    public async Task<LocationId> Handle(AddLocationRequest request, CancellationToken ct = default)
    {
