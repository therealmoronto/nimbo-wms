...
[PublicAPI]
public class DeleteAdjustmentDocumentCommandHandler : IRequestHandler<DeleteAdjustmentDocumentCommand, Result>
{
    ...
    public async Task<Result> Handle(DeleteAdjustmentDocumentCommand request, CancellationToken ct)
    {
