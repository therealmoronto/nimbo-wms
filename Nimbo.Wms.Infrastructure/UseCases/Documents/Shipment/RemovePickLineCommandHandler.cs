...
[PublicAPI]
public class RemovePickLineCommandHandler : IRequestHandler<RemovePickLineCommand>
{
    ...
    public async Task Handle(RemovePickLineCommand request, CancellationToken ct)
    {
