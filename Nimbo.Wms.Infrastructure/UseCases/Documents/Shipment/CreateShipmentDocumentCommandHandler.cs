...
[PublicAPI]
public class CreateShipmentDocumentCommandHandler : IRequestHandler<CreateShipmentDocumentCommand, Result<Guid>>
{
    ...
    public async Task<Result<Guid>> Handle(CreateShipmentDocumentCommand request, CancellationToken ct)
    {
