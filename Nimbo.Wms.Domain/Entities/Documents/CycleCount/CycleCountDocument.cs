...
public sealed class CycleCountDocument : DocumentBase<CycleCountDocumentId, CycleCountStatus, CycleCountDocumentLine>
{
    ...
    public Guid AddLine(ItemId itemId, LocationId locationId, Quantity expectedQty, StockLotId? stockLotId = null)
    {
        EnsureCanBeEdited();
        ...
        var line = new CycleCountDocumentLine(Id, locationId, itemId, expectedQty, stockLotId);
        AddLine(line);
