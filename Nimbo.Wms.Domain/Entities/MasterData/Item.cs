...
public class Item : BaseEntity<ItemId>
{
    ...
    /// <summary>
    /// When true, receiving this item requires a BatchNumber, which resolves to a VendorLot.
    /// </summary>
    ...
    public void ChangeIsBatchManaged(bool isBatchManaged) => IsBatchManaged = isBatchManaged;
