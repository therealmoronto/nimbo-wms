...
[PublicAPI]
public class CreateCycleCountDocumentCommandValidator : AbstractValidator<CreateCycleCountDocumentCommand>
{
    public CreateCycleCountDocumentCommandValidator()
    {
